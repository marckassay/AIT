...
var symlink_util_1 = require("./symlink-util");
/**
...
function symlinkGenerator() {
    var _this = this;
    return symlink_util_1.readFileAsync('symlink.config.json')
        .then(function (json) {
        return Promise.resolve(JSON.parse(json.toString()));
    })
        .then(function (config) {
        var iterateDependencies = function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, _a, dependency;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        symlink_util_1.prepareOutPathDir(config.projectOutPath);
                        _i = 0, _a = config.dependencies;
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        dependency = _a[_i];
                        return [4 /*yield*/, symlink_util_1.newSymlinkFile(dependency.name, dependency.symlinkPath, config.projectOutPath, dependency.adaptor)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
