...
export class AudioManagementMock extends AudioManagement {
  ...
  getVolume(type: AudioManagement.VolumeType, onSuccess?: (result: AudioManagement.VolumeTypeReturn) => void, onError?: () => void): Promise<any> {
    return this.getMock().then((value) => {
  ...
  getMaxVolume(type: AudioManagement.VolumeType, onSuccess?: (result: AudioManagement.VolumeTypeReturn) => void, onError?: () => void): Promise<any> {
    return this.getMock().then((value) => {
      ...
      return this.storage.ready()
        ...
        .then((value: MockStorageShape | undefined) => {
          if (!value) {
            ...
            return this.storage.set(this.MOCK_STORAGE_KEY, this.storage_shape).then((value: MockStorageShape) => {
  ...
  protected setMock(field: keyof MockStorageShape, value?: number): Promise<void> {
    ...
    if (field !== "currentAudioMode" && value === undefined) {
      throw new Error("AudioManagementMock can't set a value of undefined to MockStorageShape. Only MockStorageShape's currentAudioMode field can be assigned with no value.");
    }
