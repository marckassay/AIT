...
export class NativeAudioMock extends IonicNativePlugin {
    /**
     ...
     * Uses highlevel native APIs with a larger footprint. (iOS: AVAudioPlayer). Can be stopped /
     * looped and used with multiple voices. Can be faded in and out using the delay parameter.
     *
     * @param id {string} unique ID for the audio file
     * @param assetPath {string}  the relative path or absolute URL (inluding http://) to the audio asset.
